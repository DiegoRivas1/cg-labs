...
void render() {
    ...
    drawCircleSequenceLine(-0.75f, -0.6f, 0.12f, 5, 0.20f, 0.0f, 64);
    ...
    // Ejercicio 5a linea de círculos
    glColor3f(1.0f, 0.4f, 0.4f); // color
    drawCircleSequenceLine(0.5f, -0.6f, 0.12f, 6, 0.20f, 45.0f, 64);
}